...
class ImageDataReader(CalibrationDataReader):
    ...
    def _preprocess_images(self, image_folder: str):
        ...
        for name in img_names:
            ...
            input_data = input_image.astype(np.float32) / 255.0
...
def main(args: Namespace) -> None:
    ...
    # Exclude the YOLO detection head from quantization — these nodes are too sensitive to INT8 precision loss
    # Node names verified against yolov8m.onnx (307 nodes, 66 in model.22)
    config_copy.nodes_to_exclude = [
        "/model.22/Reshape", "/model.22/Reshape_1", "/model.22/Reshape_2", "/model.22/Reshape_5",
        "/model.22/Reshape_8", "/model.22/Reshape_9", "/model.22/Reshape_10",
        "/model.22/dfl/Reshape", "/model.22/dfl/Reshape_1", "/model.22/dfl/Transpose", "/model.22/dfl/Softmax",
        "/model.22/dfl/conv/Conv", 
        "/model.22/Slice", "/model.22/Slice_1", "/model.22/Slice_2", "/model.22/Slice_3",
        "/model.22/Sub", "/model.22/Sub_1",
        "/model.22/Add_1", "/model.22/Add_2", "/model.22/Add_3",
        "/model.22/Mul_2", "/model.22/Mul_3", "/model.22/Mul_4",
        "/model.22/Div_1",
